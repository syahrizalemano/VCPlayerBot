...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ REMODIFIED By', url='https://t.me/ezzraez'),
        ],
...
async def repo_(client, message):
    buttons = [
        [
           InlineKeyboardButton('⚙️ Deploy by', url='https://t.me/ezzraez'),
        ],
        [
